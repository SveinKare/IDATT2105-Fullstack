package ntnu.fullstack.no.calculatorbackend.security;
...
import ntnu.fullstack.no.calculatorbackend.controller.TokenController;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
  ...
  public String validateTokenAndGetUserId(final String token) {
    try {
      final Algorithm hmac512 = Algorithm.HMAC512(TokenController.SECRET_TEST);
